...
public class VisualizzaStipendioImpiegatiDaAmministratore extends JFrame{
    private JPanel VisualizzaStipendioImpiegatiDaAmministratore;
    ...
    public VisualizzaStipendioImpiegatiDaAmministratore(){
        setTitle("CitizenServices");
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        setSize(800, 300); // Imposta le dimensioni desiderate (larghezza x altezza)
        setLocationRelativeTo(null);
        setContentPane(VisualizzaStipendioImpiegatiDaAmministratore);
        setResizable(false);
        ...
        visualizzaStipendioButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Stipendio stipendio = CGS.ottieniStipendioImpiegato(matricola, mese);
                if(stipendio!=null){
                    TitoloMeseMatricola.setText("Dettagli dello stipendio per Mese " + mese + " - Matricola " + matricola);
                    ...
                    AvvisoErrore AE = new AvvisoErrore("<html>lo stipendio non è stato trovato,<br>verifica che la matricola <br>o la data inserita siano corrette</html>");
                    AE.pack();
                    AE.setVisible(true);
                }
            }
